...
- [ ] Real far starfield: the statistical shells beyond 30 pc become materializable sector stars (needs lazy slot seeding so millions of slots enumerate cheaply), making every glint in the sky travelable like the neighborhood
