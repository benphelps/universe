...
- [ ] Ground-frame completeness: moons don't rise/set (they skip the frame's spin sweep, so they hang near-fixed in a ground sky whose sun and stars rotate); ring shadows on terrain; asteroid focuses ignore their random spin axis in the frame the way solid planets now honor obliquity
